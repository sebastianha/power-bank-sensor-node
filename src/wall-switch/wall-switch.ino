...
#define RANDOM_PIN              12      // Needs to be an unconnected ANALOG pin to generate UID
...
#define RADIO_RX_PIN            5      // Not connected
#define RADIO_TX_PIN            4      // Data pin for sender
